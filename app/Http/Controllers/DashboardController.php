...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        $sales = SaleResource::collection(Sale::with(['client'])->orderBy('id', 'DESC')->paginate(10));
        $driverInvoices = DriverInvoiceResource::collection(DriverInvoice::with(['client', 'product'])->orderBy('id', 'DESC')->paginate(10));
