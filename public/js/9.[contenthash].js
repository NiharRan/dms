...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(229)("113181df", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(229)("66d8de1e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                        ...
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.__("Client Address")) +
                              ...
                              "\n                    " +
                              _vm._s(
                                _vm.translate(_vm.driver_invoice.client.phone)
                              )
                          )
                        ])
                      ]
                        ...
                        _c("span", [
                          _vm._v(
                            _vm._s(_vm.__("Dri: Mobile:")) +
                              "\n                    " +
                              _vm._s(
                                _vm.translate(_vm.driver_invoice.driver_phone)
                              )
                          )
                        ])
                      ]
                        ...
                        _c("tr", [
                          ...
                          _c("th", { staticClass: "text-center" }, [
                            _vm._v(
                              "\n                        " +
                                _vm._s(
                                  _vm.driver_invoice.measurement_type.name
                                ) +
                                "\n                      "
                            )
                          ]),
