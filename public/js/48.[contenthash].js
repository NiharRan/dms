...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(226)("1b0d9534", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(226)("14a40b06", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Shared_Layout__ = __webpack_require__(234);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Components_Model__ = __webpack_require__(254);
  ...
  methods: {
    ...
    store: function () {
      var _store = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee2() {
        var errors, self, client_id, stocks, products, tracks, quantities, prices, totals;
    ...
    fetchProducts: function fetchProducts(stock) {
      var self = this;
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.route('stocks.products', stock.id)).then(function (_ref) {
        var data = _ref.data;
        self.products = data;
      });
    },
