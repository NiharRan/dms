...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(226)("668f7684", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(226)("33b64a3b", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(226)("56d5efb8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    totalPaid: function totalPaid(data) {
      var paidPrice = data.reduce(function (paid, invoice) {
        var p = invoice.paid == '' ? 0 : invoice.paid;
        return paid + parseFloat(p);
      }, 0);
      return parseFloat(paidPrice).toFixed(2);
    },
    totalDue: function totalDue(data) {
      var duePrice = data.reduce(function (due, invoice) {
        var d = invoice.due == '' ? 0 : invoice.due;
                    ...
                    [
                      _c("thead", [
                        ...
                        _c("tr", [
                          ...
                          _vm._v(" "),
                          _c("th", [_vm._v(_vm._s(_vm.__("Paid")))]),
                          _vm._v(" "),
                          _c("th", [_vm._v(_vm._s(_vm.__("Due")))]),
                          _vm._v(" "),
                          _c("th", { staticClass: "text-center" }, [
                            ...
                            [
                              _c("tr", [
                                ...
                                _c("th", { staticClass: "text-right" }, [
                                  _vm._v(
                                    _vm._s(
                                      _vm.totalPaid(_vm.driver_invoices.data)
                                    )
                                  )
                                ]),
                                _vm._v(" "),
                                _c("th", { staticClass: "text-right" }, [
                                  _vm._v(
                                    _vm._s(
                                      _vm.totalDue(_vm.driver_invoices.data)
                                    )
                                  )
                                ])
                              ]),
                              ...
                              _vm._l(_vm.driver_invoices.data, function(
                                ...
                                return _c("tr", { key: driver_invoice.id }, [
                                  ...
                                  _vm._v(" "),
                                  _c("td", { staticClass: "text-right" }, [
                                    _vm._v(_vm._s(driver_invoice.paid))
                                  ]),
                                  _vm._v(" "),
                                  _c("td", { staticClass: "text-right" }, [
                                    _vm._v(_vm._s(driver_invoice.due))
                                  ]),
                                  _vm._v(" "),
                                  _c(
                                    "td",
