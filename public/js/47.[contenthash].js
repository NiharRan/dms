...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(233)("1b0d9534", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(233)("14a40b06", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Shared_Layout__ = __webpack_require__(241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Components_Model__ = __webpack_require__(261);
    ...
    fetchCommission: function fetchCommission() {
      ...
      if (this.form.reference != "") {
        __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(this.route("drivers.invoices.commissions", this.form.reference)).then(function (_ref) {
          var data = _ref.data;
          _this.form.commission = data.commission == "" ? 0.0 : parseFloat(data.commission).toFixed(2);
        })["catch"](function (err) {
          console.log(err);
        });
      }
