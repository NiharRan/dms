...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(229)("762ac726", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(229)("4e0645a7", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                        ...
                        ? _c(
                            ...
                            _vm._l(_vm.stock_details.data, function(
                              ...
                              return _c("tr", { key: stock_detail.id }, [
                                ...
                                _vm._v(" "),
                                _c("th", { staticClass: "text-center" }, [
                                  _vm._v(_vm._s(stock_detail.quantity))
                                ]),
                                _vm._v(" "),
                                _c("th", { staticClass: "text-center" }, [
                                  _vm._v(_vm._s(stock_detail.amount))
                                ]),
                                _vm._v(" "),
                                _c("td", {
                                  domProps: {
