<template>
  <body
    ...
    :class="
      `${$page.configData.blankPageClass} ${$page.configData.navbarType} ${$page.configData.bodyClass} ${$page.configData.footerType}` +
      [$page.configData.theme === 'light' ? '' : $page.configData.theme]
    "
