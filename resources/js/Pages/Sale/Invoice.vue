          ...
          <div class="card-content">
                ...
                <div class="invoice-body">
                  ...
                  <table class="table font-medium-3">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th colspan="4" class="text-right">{{ __("Paid") }}</th>
                        <th class="text-right">
                          {{ parseFloat(sale.total_paid).toFixed(3) }}
                        </th>
                      </tr>
                      <tr>
                        <th colspan="4" class="text-right">{{ __("Due") }}</th>
                        <th class="text-right">
            ...
            <div class="card-footer text-right">
              ...
              <a :href="route('sales.edit', sale.id)" class="btn btn-primary"
                ><i class="feather icon-edit"></i> {{ __("Edit") }}</a
              >
              <a
                :href="route('sales.invoices.print', sale.invoice)"
                target="_blank"
                class="btn btn-info"
                ><i class="feather icon-printer"></i> {{ __("Print") }}</a
              >
      ...
      <form @submit.prevent="payment">
        <div class="modal-body">
          ...
          <label class="float-left mt-2">
            <input type="checkbox" v-model="form.payment_from_balance" />
...
export default {
  ...
  methods: {
    ...
    payment: function () {
      let self = this;
      this.$inertia
        .post(this.route("sales.invoices.pay", this.form.invoice), {
