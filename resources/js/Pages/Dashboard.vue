<template>
  <layout name="Dashboard">
    <section id="dashboard-analytics">
          ...
          <div class="col-lg-8 col-sm-12">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-12">
                <div class="card">
                  <div
                    class="card-header d-flex flex-row align-items-start pb-0"
                  >
                    <div class="avatar bg-rgba-primary p-50 m-0">
                      <div class="avatar-content">
                        <i
                          class="feather icon-users text-primary font-medium-5"
                        ></i>
                      </div>
                    </div>
                    <div>
                  ...
                  <div class="card-body">
                    <a
                      ...
                      class="text-center btn btn-block btn-outline-primary"
                      >{{ __("All Clients") }}</a
                    >
                  </div>
                </div>
                ...
                <div class="card">
                  ...
                  >
                    <div class="avatar bg-rgba-info p-50 m-0">
                      <div class="avatar-content">
                        <i
                          class="feather icon-package text-info font-medium-5"
                        ></i>
                      </div>
                    </div>
                    <h2 class="text-bold-700 mt-1 mb-25">
                  ...
                  <div class="card-body">
                    <a
                      ...
                      class="text-center btn btn-block btn-outline-info"
                      >{{ __("All Products") }}</a
                    >
                  </div>
                </div>
                ...
                <div class="card">
                  ...
                  >
                    <div class="avatar bg-rgba-warning p-50 m-0">
                      <div class="avatar-content">
                        <i
                          class="feather icon-users text-warning font-medium-5"
                        ></i>
                      </div>
                    </div>
                    <h2 class="text-bold-700 mt-1 mb-25">
                  ...
                  <div class="card-body">
                    <a
                      ...
                      class="text-center btn btn-block btn-outline-warning"
                      >{{ __("Today's Driver Invoices") }}</a
                    >
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  >
                    <div class="avatar bg-rgba-success p-50 m-0">
                      <div class="avatar-content">
                        <i
                          class="feather icon-package text-success font-medium-5"
                        ></i>
                      </div>
                    </div>
                  ...
                  <div class="card-body">
                    <a
                      ...
                      class="text-center btn btn-block btn-outline-success"
                      >{{ __("Today's Sales") }}</a
                    >
                  </div>
                </div>
              ...
              <div class="card-content">
                <div class="card-body text-center">
                  ...
                  <div class="text-center">
                    ...
                    <h2 class="mb-0 text-white text-italic">
                      {{ $page.auth.name }}
                    </h2>
                    <h3 class="mb-0 btn btn-outline-light text-white">
                      {{ clock }}
                    </h3>
                  </div>
                </div>
                  ...
                  <table class="table table-hover-animation mb-0">
                    ...
                    <tbody>
                      <tr v-for="sale in sales.data" :key="sale.id">
                        ...
                        <td
                          class="text-left"
                          v-html="$options.filters.payment_status(sale.status)"
                        ></td>
                        <td class="text-center">
                          <a
              ...
              <div class="card-content">
                <div class="table-responsive mt-1">
                  <table class="table table-hover-animation mb-0">
                    ...
                    <tbody>
                      <tr
                        v-for="driver_invoice in driver_invoices.data"
                      ...
                      >
                        ...
                        <td
                          class="text-left"
                          v-html="
                            $options.filters.payment_status(
      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 md-offset-4 col-sm-12">
          <div class="card bg-analytics text-white">
            <div class="card-content">
              <div class="card-body text-center">
                <img
