        ...
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="table-responsive" v-if="product_types.data.length > 0">
                <table id="data-table" class="table table-bordered display responsive nowrap mb-0" style="width: 100%">
                  ...
                  <tbody>
                    <tr v-for="(product_type, index) in product_types.data" :key="product_type.id">
                      <th>{{ index + 1 }}</th>
                      <th>{{ product_type.name }}</th>
                      <td>{{ product_type.default_date_time }}</td>
